...
The code is, mostly, not generated by AI. But since code is best generated using an agent these days I did add a `CLAUDE.md` file in the root describing the project after I set up the structure and done a few iterations by hand. After that I used Claude Code with the `swift-concurrency` and `swiftui-expert-skill` to review the code to make sure it was well written.
